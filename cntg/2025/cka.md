...
- DATABASES = HIGH IOPS = BLOCK STORAGE = LOCAL STORAGE = RWO = STATEFULSET (MIGHT REQUIRE SYNCHRONIZATION)
- WEBSERVERS = LOW IOPS = OBJECT/FILESYSTEM STORAGE = REMOTE STORAGE = RWX/ROX = DEPLOYMENT/DAEMONSET
