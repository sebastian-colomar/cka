...
kubectl apply -f https://raw.githubusercontent.com/sebastian-colomar/phpinfo/main/kube-compose-rc-echo.yaml
kubectl get svc
kubectl get rc
kubectl get po
...
kubectl apply -f https://raw.githubusercontent.com/sebastian-colomar/phpinfo/main/kube-compose-rs-echo.yaml
kubectl get svc
kubectl get rs
kubectl get po
```
